...
///
/// This function executes many times simultaneously as a 'thread main'.
///
/// note: code must ensure that update of the display by one racer is "atomic".
///
/// @pre racer cannot be NULL.
/// @param racer a Racer, declared as void* to be compatible with pthread
///		  interface
